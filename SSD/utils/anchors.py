...
class AnchorBox():
    ...
    def call(self, layer_shape, mask=None):
        ...
        box_heights = []
        # -------------------------------#
        # self.aspect_ration has two values
        # eg: [1,1,2,1/2] || [1,1,2,1/2,3,1/3]
        # -------------------------------#
        ...
        def __init__(self, input_shape, min_size, max_size=None, aspect_ratios=None, flip=True):
            ...
            class AnchorBox_for_Vision():
                ...
                def call(self, layer_shape, mask=None):
                    ...
                    if layer_height == 3:
                        rect1 = plt.Rectangle([anchor_boxes[4, 0], anchor_boxes[4, 1]], box_widths[0] * 2,
                                              box_heights[0] * 2, color="r", fill=False)
                        rect2 = plt.Rectangle([anchor_boxes[4, 4], anchor_boxes[4, 5]], box_widths[1] * 2,
                                              box_heights[1] * 2, color="r", fill=False)
                        rect3 = plt.Rectangle([anchor_boxes[4, 8], anchor_boxes[4, 9]], box_widths[2] * 2,
                                              box_heights[2] * 2, color="r", fill=False)
                        rect4 = plt.Rectangle([anchor_boxes[4, 12], anchor_boxes[4, 13]], box_widths[3] * 2,
                                              box_heights[3] * 2, color="r", fill=False)
            ...
            for i in range(len(feature_heights)):
                anchors.append(AnchorBox_for_Vision(input_shape, anchors_size[i], max_size=anchors_size[i + 1],
                                                    aspect_ratios=aspect_ratios[i]).call(
