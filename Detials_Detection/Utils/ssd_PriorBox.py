...
class PriorBox():
    def __init__(self,img_size,min_size,max_size,
                 aspect_ratios=None,flip=True,variances=[0.1],clip=True,**kwargs):
    ...
    def call(self,input_shape,mask=None):
        ...
        # each box need(center_x,center_y), 1st caculate left-top, then right-down
        prior_boxes = np.concatenate((centers_x,centers_y),axis=1)
        prior_boxes = np.title(prior_boxes,(1,2*num_priors_))
